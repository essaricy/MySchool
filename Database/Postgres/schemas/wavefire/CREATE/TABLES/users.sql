...
ALTER TABLE wavefire.USERS ADD UNIQUE (REF_USER_TYPE_ID, REF_USER_ID, USER_NAME);


CREATE TABLE wavefire.USER_THEME (
    CODE varchar(64) NOT NULL,
    NAME varchar(64) NOT NULL,
    PRIMARY KEY (CODE)
);
ALTER TABLE wavefire.USER_THEME ADD UNIQUE (CODE);
ALTER TABLE wavefire.USER_THEME ADD UNIQUE (NAME);
...
CREATE TABLE wavefire.USER_SESSION (
...
ALTER TABLE wavefire.USER_SESSION ADD CONSTRAINT FK_USER_ID FOREIGN KEY (USER_ID) REFERENCES wavefire.USERS (USER_ID);

CREATE TABLE wavefire.USER_ACTIVITY (
...
ALTER TABLE wavefire.USER_ACTIVITY ADD CONSTRAINT FK_SESSION_ID FOREIGN KEY (SESSION_ID) REFERENCES wavefire.USER_SESSION (SESSION_ID);
