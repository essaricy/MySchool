...
$BODY$
 ...
 BEGIN
     IF TG_OP = 'DELETE' THEN
         ...
         DELETE FROM wavefire.ATTENDANCE_PROFILE_STATE WHERE ATTENDANCE_PROFILE_ID = OLD.profile_id;
         DELETE FROM wavefire.ATTENDANCE_PROFILE_REGION WHERE ATTENDANCE_PROFILE_ID = OLD.profile_id;
         DELETE FROM wavefire.ATTENDANCE_PROFILE_BRANCH WHERE ATTENDANCE_PROFILE_ID = OLD.profile_id;
