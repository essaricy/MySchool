...
INSERT INTO wavefire.MYSCHOOL_PROFILE (EMAIL_ACTIVE, EMAIL_EMPLOYEES, EMAIL_STUDENTS, SMS_ACTIVE, SMS_EMPLOYEES, SMS_STUDENTS, USE_MENU_ICONS)
...
INSERT INTO wavefire.REF_MODULE (MODULE_ID, MODULE_NAME, CAN_ADMIN_ACCESS, CAN_EMPLOYEE_ACCESS, CAN_STUDENT_ACCESS, ACCESS_URL) VALUES (
    (SELECT COALESCE(MAX(MODULE_ID)+1, 1) FROM wavefire.REF_MODULE), 'Notice Board', 'Y', 'Y', 'Y', '#');
INSERT INTO wavefire.REF_MODULE (MODULE_ID, MODULE_NAME, CAN_ADMIN_ACCESS, CAN_EMPLOYEE_ACCESS, CAN_STUDENT_ACCESS, ACCESS_URL) VALUES (
...
INSERT INTO wavefire.REF_MODULE (MODULE_ID, MODULE_NAME, CAN_ADMIN_ACCESS, CAN_EMPLOYEE_ACCESS, CAN_STUDENT_ACCESS, ACCESS_URL) VALUES (
    (SELECT COALESCE(MAX(MODULE_ID)+1, 1) FROM wavefire.REF_MODULE), 'Find Us', 'Y', 'Y', 'Y', '#');
INSERT INTO wavefire.REF_MODULE (MODULE_ID, MODULE_NAME, CAN_ADMIN_ACCESS, CAN_EMPLOYEE_ACCESS, CAN_STUDENT_ACCESS, ACCESS_URL) VALUES (
...
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    (SELECT COALESCE(MAX(FUNCTION_ID)+1, 1) FROM wavefire.FUNCTION), 'About Director',
    (SELECT MODULE_ID FROM wavefire.REF_MODULE WHERE MODULE_NAME = 'Notice Board'), 'noticeBoard/director.htm', 'boss.png');
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    (SELECT COALESCE(MAX(FUNCTION_ID)+1, 1) FROM wavefire.FUNCTION), 'About Organization',
    (SELECT MODULE_ID FROM wavefire.REF_MODULE WHERE MODULE_NAME = 'Notice Board'), 'noticeBoard/organization.htm', 'text_signature.png');
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    (SELECT COALESCE(MAX(FUNCTION_ID)+1, 1) FROM wavefire.FUNCTION), 'Our Achievements',
    (SELECT MODULE_ID FROM wavefire.REF_MODULE WHERE MODULE_NAME = 'Notice Board'), 'noticeBoard/achievements.htm', 'trophy_silver.png');
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    (SELECT COALESCE(MAX(FUNCTION_ID)+1, 1) FROM wavefire.FUNCTION), 'Upcoming Events',
    (SELECT MODULE_ID FROM wavefire.REF_MODULE WHERE MODULE_NAME = 'Notice Board'), 'noticeBoard/upcomingEvents.htm', 'rainbow.png');
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    (SELECT COALESCE(MAX(FUNCTION_ID)+1, 1) FROM wavefire.FUNCTION), 'Upcoming Exams',
...
-- Find Us functions
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    (SELECT COALESCE(MAX(FUNCTION_ID)+1, 1) FROM wavefire.FUNCTION), 'Contact Us',
    (SELECT MODULE_ID FROM wavefire.REF_MODULE WHERE MODULE_NAME = 'Find Us'), 'findus/contactUs.htm', 'telephone.png');
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    (SELECT COALESCE(MAX(FUNCTION_ID)+1, 1) FROM wavefire.FUNCTION), 'Locate Us',
    (SELECT MODULE_ID FROM wavefire.REF_MODULE WHERE MODULE_NAME = 'Find Us'), 'findus/locateUs.htm', 'direction.png');
...
INSERT INTO wavefire.FUNCTION (FUNCTION_ID, FUNCTION_NAME, REF_MODULE_ID, ACCESS_URL, ICON_URL) VALUES (
    ...
    (SELECT MODULE_ID FROM wavefire.REF_MODULE WHERE MODULE_NAME = 'Web Admin'), '#', 'calculator.png');
