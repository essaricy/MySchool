...
ALTER TABLE USERS ADD CONSTRAINT FK_REF_USER_TYPE_ID FOREIGN KEY (REF_USER_TYPE_ID) REFERENCES REF_USER_TYPE (USER_TYPE_ID);
ALTER TABLE USERS ADD UNIQUE (REF_USER_TYPE_ID, REF_USER_ID, USER_NAME);
