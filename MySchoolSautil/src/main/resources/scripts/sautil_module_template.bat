...
set MYSCHOOL_DIR=@MYSCHOOL.DIR@
set CONFIG_DIR=%MYSCHOOL_DIR%/config
...
set CLASSPATH=%CLASSPATH%;%LIB_DIR%/batik-xml-1.6.jar
...
set CLASSPATH=%CLASSPATH%;%LIB_DIR%/commons-pool-1.6.jar
