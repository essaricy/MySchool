...
function show(tableRow) {
    ...
    //var detail_table = document.getElementById('functions_table_div_' + tableRow);
...
function getDefaultprivileges(userTypeId) {
    if (userTypeId > 0) {
        document.forms[0].userTypeId.value=userTypeId;
        submitPage('<%=request.getContextPath()%>/privileges/defaultPrivileges.htm', '');
    }
}

function submitForm() {
    var userTypeId = $('#userTypes').val();
    ...
    <tr>
        ...
        <td align="left">
            <c:if test="${userTypes != null}">
                ...
                <select name="userTypes" id="userTypes" class="chosen-select" onchange="getDefaultprivileges(this.options[selectedIndex].value)">
     ...
     <tr>
         <td colspan="2" valign="top">&nbsp;
             ...
             <!-- <input type="hidden" id="privilegesData" name="privilegesData" value="" /> -->
