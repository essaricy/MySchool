<div style="padding-left: 10px; padding-right: 10px; clear: none;">
<h2 class="formHeading">Quickly Find What You Are Looking For</h2>
<table width="100%">
  <tr>
    <!-- ################################################################################################ -->
    <td>
    <ul style="margin: 0; padding: 0; list-style: none; display: block; -webkit-margin-before: 1em; -webkit-margin-after: 1em; -webkit-margin-start: 0px; -webkit-margin-end: 0px; -webkit-padding-start: 40px; text-align: left; font-size: 14px; line-height: 1.4em;">
      ...
      <li><a href="<%=request.getContextPath()%>/public/locateUs.htm">Locate Us</a></li>
      <li><a href="<%=request.getContextPath()%>/public/contactUs.htm">Contact Us</a></li>
    </ul>
    </td>
    <!-- ################################################################################################ -->
    <td>
    ...
    <td>
    <ul style="margin: 0; padding: 0; list-style: none; display: block; -webkit-margin-before: 1em; -webkit-margin-after: 1em; -webkit-margin-start: 0px; -webkit-margin-end: 0px; -webkit-padding-start: 40px; text-align: left; font-size: 14px; line-height: 1.4em;">
      <li><a href="<%=request.getContextPath()%>/acl/assistance.htm">Students Registration</a></li>
      <li><a href="<%=request.getContextPath()%>/acl/assistance.htm">Employee Registration</a></li>
      <li><a href="<%=request.getContextPath()%>/acl/admin.htm">Administration</a></li>
    </ul>
    </td>
  </tr>
</table>
