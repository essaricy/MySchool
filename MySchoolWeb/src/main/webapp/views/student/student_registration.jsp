...
jQuery(document).ready(function() {
  ...
  var destinationUrl = null;
    if ($('#SEARCH_MODE').val() == 'VERIFIED') {
      destinationUrl = '<%=request.getContextPath()%>/student/launchVerifiedStudentsSearch.htm';
    } else if ($('#SEARCH_MODE').val() == 'UNVERIFIED') {
      destinationUrl = '<%=request.getContextPath()%>/student/launchUnverifiedStudentsSearch.htm';
  }
