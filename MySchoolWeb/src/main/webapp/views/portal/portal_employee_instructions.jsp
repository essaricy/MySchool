...
jQuery(document).ready(function() {
  $('#EmployeFormRow').hide();
  $('#EmployeeFormActionButtons').hide();

  $("#ESSInstructions h3.expand").toggler();
  $("#ESSInstructions h3.expand").each(function() {
      $(this).click();
  });
  ...
  $('#InstructionsRead').click(function() {
    ...
    $('#EmployeFormRow').show(1000);
    $('#EmployeeFormActionButtons').show();
  });
...
<div id="ESSInstructionsWrapper" class="expand-collapse-wrapper"> 
  <div id="ESSInstructions" class="expand-collapse-content">  
    <div class="expand-collapse">
      <h3 class="expand">Employee Alert!!! [Beware of phishing]</h3>
      <div class="collapse">
        <ul>
