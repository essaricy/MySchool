...
<c:if test="${uiControl == 'label'}">
    <c:if test="${value == 'M'}">Male</c:if>
    <c:if test="${value == 'F'}">Female</c:if>
</c:if>
...
<c:if test="${uiControl == 'select'}">
    ...
    <c:if test="${value == 'M'}"><option value="M" selected>Male</option></c:if>
    <c:if test="${value != 'M'}"><option value="M">Male</option></c:if>

    <c:if test="${value == 'F'}"><option value="F" selected>Female</option></c:if>
    <c:if test="${value != 'F'}"><option value="F">Female</option></c:if>
