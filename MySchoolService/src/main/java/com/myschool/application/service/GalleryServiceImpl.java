...
public class GalleryServiceImpl implements GalleryService {
    ...
    /* (non-Javadoc)
     * @see com.myschool.application.service.GalleryService#getAllInDetail()
     */
    @Override
    public List<GalleryDetailDto> getAllInDetail() throws ServiceException {
        try {
            return galleryManager.getAllInDetail();
        } catch (DataException dataException) {
            throw new ServiceException(dataException.getMessage(),
                    dataException);
        }
     ...
     * (non-Javadoc)
     * 
     * @see com.myschool.application.service.Servicable#update(int,
     * java.lang.Object)
     */
    @Override
    public boolean update(int id, GalleryDetailDto galleryDetail) throws ServiceException {
        throw new ServiceException(
                "Use update(galleryName, galleryDetail) instead");
    }
     ...
     * 
     * @see
     * com.myschool.application.service.GalleryService#get(java.lang.String)
     */
    @Override
    public GalleryDetailDto get(String galleryName) throws ServiceException {
        try {
            return galleryManager.getGallery(galleryName);
        } catch (DataException dataException) {
            throw new ServiceException(dataException.getMessage(),
                    dataException);
        }
     ...
     * 
     * @see
     * com.myschool.application.service.GalleryService#create(java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * com.myschool.application.service.GalleryService#update(java.lang.String,
     * java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * com.myschool.application.service.GalleryService#delete(java.lang.String)
     */
    @Override
     ...
     * 
     * @see
     * com.myschool.application.service.GalleryService#pin(java.lang.String)
     */
    @Override
