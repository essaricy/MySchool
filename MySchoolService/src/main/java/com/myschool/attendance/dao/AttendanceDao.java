...
public interface AttendanceDao {
    ...
    *//**
     ...
     * @throws DaoException the dao exception
     *//*
    //AttendanceDto getStudentAttendance(int studentId, int year, int month) throws DaoException;
    ...
    *//**
    ...
    List<AttendanceCodeDto> getAttendanceCodes() throws DaoException;

    List<AttendanceCodeDto> getReferredAttendanceCodes() throws DaoException;

    List<AttendanceCodeDto> getAssignedAttendanceCodes() throws DaoException;
